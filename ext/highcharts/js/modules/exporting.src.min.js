...
T||(b[F]=T=c(w,{className:t},{position:C,zIndex:1e3,padding:H+G},b.container),h=c(w,null,g({MozBoxShadow:P,WebkitBoxShadow:P,boxShadow:P},v.menuStyle),T),m=function(){u(T,{display:k}),p&&p.setState(0),b.openMenu=!1},a(T,"mouseleave",function(){x=setTimeout(m,500)}),a(T,"mouseenter",function(){clearTimeout(x)}),a(i,"mouseup",$),a(b,"destroy",function(){s(i,"mouseup",$)}),d(e,function(t){if(t){var e=t.separator?c("hr",null,null,h):c(w,{onmouseover:function(){u(this,v.menuItemHoverStyle)},onmouseout:function(){u(this,S)},onclick:function(e){e&&e.stopPropagation(),m(),t.onclick&&t.onclick.apply(b,arguments)},innerHTML:t.text||b.options.lang[t.textKey]},g({cursor:"pointer"},S),h)
b.exportDivElements.push(e)}}),b.exportDivElements.push(h,T),b.exportMenuWidth=T.offsetWidth,b.exportMenuHeight=T.offsetHeight),y={display:"block"},n+b.exportMenuWidth>E?y.right=E-n-r-H+G:y.left=n-H+G,o+l+b.exportMenuHeight>M&&"top"!==p.alignOptions.verticalAlign?y.bottom=M-o-H+G:y.top=o+l-H+G,u(T,y),b.openMenu=!0},addButton:function(e){var o,i,r=this,a=r.renderer,s=h(r.options.navigation.buttonOptions,e),l=s.onclick,c=s.menuItems,p={stroke:s.symbolStroke,fill:s.symbolFill},u=s.symbolSize||12
if(r.btnCount||(r.btnCount=0),r.exportDivElements||(r.exportDivElements=[],r.exportSVGElements=[]),s.enabled!==!1){var d,m=s.theme,x=m.states,f=x&&x.hover,y=x&&x.select
delete m.states,l?d=function(t){t.stopPropagation(),l.call(r,t)}:c&&(d=function(){r.contextMenu(i.menuClassName,c,i.translateX,i.translateY,i.width,i.height,i),i.setState(2)}),s.text&&s.symbol?m.paddingLeft=t.pick(m.paddingLeft,25):s.text||g(m,{width:s.width,height:s.height,padding:0}),i=a.button(s.text,0,0,d,m,f,y).attr({title:r.options.lang[s._titleKey],"stroke-linecap":"round"}),i.menuClassName=e.menuClassName||E+"menu-"+r.btnCount++,s.symbol&&(o=a.symbol(s.symbol,s.symbolX-u/2,s.symbolY-u/2,u,u).attr(g(p,{"stroke-width":s.symbolStrokeWidth||1,zIndex:1})).add(i)),i.add().align(g(s,{width:i.width,x:t.pick(s.x,n)}),!0,"spacingBox"),n+=(i.width+s.buttonSpacing)*("right"===s.align?-1:1),r.exportSVGElements.push(i,o)}},destroyExport:function(t){var e,n,o=t.target
for(e=0;e<o.exportSVGElements.length;e++)n=o.exportSVGElements[e],n&&(n.onclick=n.ontouchstart=null,o.exportSVGElements[e]=n.destroy())
for(e=0;e<o.exportDivElements.length;e++)n=o.exportDivElements[e],s(n,"mouseleave"),o.exportDivElements[e]=n.onmouseout=n.onmouseover=n.ontouchstart=n.onclick=null,p(n)}}),M.menu=function(t,e,n,o){var i=[b,t,e+2.5,v,t+n,e+2.5,b,t,e+o/2+.5,v,t+n,e+o/2+.5,b,t,e+o-1.5,v,t+n,e+o-1.5]
return i},r.prototype.callbacks.push(function(t){var e,o=t.options.exporting,i=o.buttons
if(n=0,o.enabled!==!1){for(e in i)t.addButton(i[e])
a(t,"destroy",t.destroyExport)}})})
