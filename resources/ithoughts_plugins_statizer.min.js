...
$.post(ithoughts_plugins_statizer.ajax,{action:"ithoughts_plugins_statizer-get_chart_ajax",data:{plugins:t,details:i,chartId:n}},function(e){e.success?(ithoughts_plugins_statizer_plugins.push(e.data),a()):console.error("Error while getting chart via Ajax",e)})})
a()})
